...
const Profile = () => {
    ...
    useEffect(() => {
        if(localStorage.getItem('access_token') === null){                   
            ...
            (async () => {
                try {
                    let profile_url = `${BASE_URL}/api/profile/${profileId}/`//profile_url = `${BASE_URL}/api/profile/`;
                    // if (profileId) {
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex flex-row gap-6">
                            ...
                            <div>
                                ...
                                {isEditing 
                                ? <input className={`${INPUT_FIELD_STYLE} w-[250px] pl-[10px]`} type="phone" value={`${userdata.number_phone}`} onChange={(e) => {setUserdata({...userdata, number_phone: e.target.value })}}/>
